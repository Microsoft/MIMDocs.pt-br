...
Uma preocupação real das empresas hoje é o acesso aos recursos em um ambiente do Active Directory. São particularmente preocupantes:
...
- [Atenuação de ataques Pass-the-Hash (PtH) e outros roubos de credenciais, versão 1 e 2](https://www.microsoft.com/download/details.aspx?id=36036)
