...
| DomainDataSource                | Essa fonte de dados fornece uma enumeração de domínios, com base nos recursos de configuração de domínio. Essa fonte de dados pode ser usada somente em RCDCs que são para recursos de grupo e recursos de usuário. | Sim | Domínio |
...
- **MaxHeight:** essa propriedade especifica a altura máxima do ícone na seção de legenda. Esta propriedade é opcional. Essa propriedade utiliza um valor inteiro em pixels. O valor padrão é 32 pixels.
