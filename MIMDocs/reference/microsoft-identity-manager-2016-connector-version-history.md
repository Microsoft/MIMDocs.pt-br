...
* SQL genérico:</br>
  **Sintomas de cenário:**   Trata-se de uma limitação bem conhecida com o conector do SQL onde permitimos apenas uma referência a um tipo de objeto e exigem referência cruzada com membros. </br>
