...
ms.locfileid: "92757218"
---
# <a name="get-user-certificates"></a>Obter certificados de usuário
Obtém a lista de certificados que estão associados a um usuário especificado. Os certificados desativados são filtrados na lista.
...
Emissor | O emissor.
NotAfter | A data e a hora após as quais o certificado não é mais válido.
NotBefore | A data e a hora em que o certificado se torna válido.
RequesterName | A conta que solicitou o certificado.
...
Esta seção fornece um exemplo para obter os certificados associados a um usuário.
