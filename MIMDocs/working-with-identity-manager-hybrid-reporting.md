...
- **Atividade de redefinição de senha**: exibe todas as instâncias em que um usuário realizou redefinição de senha usando a SSPR (redefinição de senha por autoatendimento) e fornece as portas ou os métodos usados para autenticação.
