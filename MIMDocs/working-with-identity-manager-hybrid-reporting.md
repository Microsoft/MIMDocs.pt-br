...
---
# Trabalhando com o relatório híbrido do Microsoft Identity Manager – Visualização Pública (atualização)
...
## Instale o Agente de Relatório do Microsoft Identity Manager no Azure AD
