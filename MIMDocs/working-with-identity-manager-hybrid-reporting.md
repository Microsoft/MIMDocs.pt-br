...
|--------------|------|-----------------|
|Informações|4121|Os dados de evento do Identity Manager que incluem todos os dados da solicitação.|
|Informações|4137|Extensão 4121 de evento do Identity Manager, no caso de haver dados demais para um único evento. O cabeçalho neste evento é exibido no seguinte formato: `"Request: <GUID> , message <xxx> out of <xxx>`.|
