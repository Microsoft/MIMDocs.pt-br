...
-   Você convidou ou convida um ou mais convidados criados no Azure AD <https://docs.microsoft.com/azure/active-directory/active-directory-b2b-self-service-portal>
