# [Visão geral](microsoft-identity-manager-2016.md)
...
## [Idiomas com suporte](microsoft-identity-manager-2016-language-support.md)
...
## [Práticas recomendadas](mim-best-practices.md)
...
## [Licenciamento e download](microsoft-identity-manager-licensing.md)
## [Manipulação de dados](mim-privacy-compliance.md)
## [Implantação em ambientes de modo TLS 1.2 ou FIPS](preparing-tls.md)
## [Implantação inicial](microsoft-identity-manager-deploy.md)
### [Configuração de domínio](preparing-domain.md)
### [Configuração de domínio para GMSA](preparing-domain-gmsa.md)
...
### [Instalação de MIM: sincronização](install-mim-sync.md)
### [Instalação de MIM: serviço e portal](install-mim-service-portal.md)
### [Instalação de MIM: bancos de dados de sincronização](install-mim-sync-ad-service.md)
## [Atualizar do Forefront Identity Manager 2010 R2](microsoft-identity-manager-2016-upgrade-from-fim-2010-R2.md)
## [Atualizar para o MIM 2016 SP2](microsoft-identity-manager-2016-service-pack-2-upgrade-path.md)
...
## [Usar o Servidor da MFA do Azure no PAM ou na SSPR](working-with-mfaserver-for-mim.md)
## [Usar um provedor de MFA personalizado no PAM ou na SSPR](working-with-custommfaserver-for-mim.md)
...
## [Analisador de Práticas Recomendadas](https://technet.microsoft.com/library/jj203402)
...
## [Software de identidade da Microsoft: versões de build de lançamento público](https://blogs.technet.microsoft.com/iamsupport/idmbuildversions/)
...
#### [Visão geral do conector de serviços web genérico](./reference/microsoft-identity-manager-2016-ma-ws.md)
#### [Etapas de instalação para a ferramenta de configuração da Web](./reference/microsoft-identity-manager-2016-ma-ws-install.md)
#### [Guia do fluxo de trabalho do Conector do Serviço Web para SOAP](./reference/microsoft-identity-manager-2016-ma-ws-soap.md)
#### [Guia do fluxo de trabalho do Conector do Serviço Web para exemplo de REST](./reference/microsoft-identity-manager-2016-ma-ws-restgeneric.md)
#### [Exemplo de Serviço de Aplicativo de REST do Conector de Serviço Web](./reference/microsoft-identity-manager-2016-ma-ws-restsample.md)
#### [Opções de configuração do Conector do Serviço Web](./reference/microsoft-identity-manager-2016-ma-ws-maconfig.md)
#### [Importação do Conector dos Serviços Web](./reference/microsoft-identity-manager-2016-ma-ws-import.md)
### BHOLD
...
### [Histórico de lançamento de versão do conector](./reference/microsoft-identity-manager-2016-connector-version-history.md)
## Conectores
...
### [Passo a passo de SQL genérico](./reference/microsoft-identity-manager-2016-connector-genericsql-step-by-step.md)
